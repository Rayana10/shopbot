...
token="6812720404:AAEz0LQXJF-BOy-CrNKs_iz9IP_R9twSllg"
admin_id = 5909260406
...
async def get_products(message:types.Message):
    product = db_get_products_by_category()
    photo = FSInputFile(str(product[0][3])) 
    text = str(product[0][2])
